function firstpirod() {
    ...
    const addassiment = document.querySelector('.add-Mesure')
...
//add grade
    function addgrade(){
        ...
        addedassiment.forEach((assigmentn) => {
             ...
             content += `
            <div class="added-pointcard pointcard rounded-md ml-3  mb-2 p-2 border border-solid "> 
               <span class="text-blue-400 text-lg"> Your Added assigments </span> <br>
                ...
                <div class="pooints flex">
                    <input name="points" class="form-control w-20 addedpoint text-xs ml-2 firstclass " value="${assigmentn.point}" type="number" disabled="">  /
                    <input class="form-control w-20 added-total-point total-points  text-xs  " value="${assigmentn.totalpoint}" type="text" disabled=""> 
                </div>
             </div>
            `
        })
...
//point earned
    ...
    function Gpa(){
       let studentgpa =  Math.floor(((allTasksum/allTasksumTotal * 90/100) + (practiceSum/practiceSumTotal * 10/100)) * 100)
        gpa = studentgpa
        classgrade.append(studentgpa + "%")
        console.log(practiceSum,practiceSumTotal)
    }
    Gpa()
...
function getEvents(){
    ...
    let studentgpa2 =  Math.floor(((allTasksum/allTasksumTotal * 90/100) + (practiceSum/practiceSumTotal * 10/100)) * 100)
    // addgradedisplay
    gpa = studentgpa2
    console.log(studentgpa2)
    localStorage.setItem("gpa",JSON.stringify(gpa));

    console.log(allTasksumTotal, allTasksum)
  ...
  // let myassiment = "0"
    ...
    classclose.addEventListener('click', function() {
        ...
        secondpiroid.classList.toggle('pt5')
    ...
    let alltaskup = 0;
        ...
        function pointscalc2(){
            ...
            for(let i = 0; i < alltaskassigments.length; i++){
                console.log(alltaskassigments[i])
                localStorage.setItem('allTasksum', allTasksum)
                allTasksum.length = 0
            }
            for(let i = 0; i < practicepoint.length; i++){
                console.log(practicepoint[i])
                localStorage.setItem('practiceSum', practiceSum)
                practiceSum.length = 0  
            }


            console.log(practiceSum, allTasksum)
...
function getEvents(){
  ...
  // let myassiment = "0"
    ...
    classclose.addEventListener('click', function() {
        classtogle.classList.toggle('block')
        thirdpiroid.classList.toggle('pt5')
    })
...
function thirdpirod(){
    ...
    function getEvents(){
      ...
      // let myassiment = "0"
        ...
        classclose.addEventListener('click', function() {
            classtogle.classList.toggle('block')
            forthpiroid.classList.toggle('pt5')
...
function getEvents(){
  ...
  // let myassiment = "0"
    ...
    classclose.addEventListener('click', function() {
        classtogle.classList.toggle('block')
        fifthpiroid.classList.toggle('pt5')
...
function getEvents(){
  ...
  // let myassiment = "0"
    ...
    classclose.addEventListener('click', function() {
        classtogle.classList.toggle('block')
        sixthpiroid.classList.toggle('pt5')
...
function getEvents(){
  ...
  // let myassiment = "0"
    ...
    classclose.addEventListener('click', function() {
        classtogle.classList.toggle('block')
        seventhpiroid.classList.toggle('pt5')
...
function Gpamain(){
    ...
    toalgpa.value = Math.round(100*studentgpa)/100
